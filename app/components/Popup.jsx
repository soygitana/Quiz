...
class Popup extends React.Component {
    constructor(props) {
        ...
        this.state = {
            ...
            text: 'This is a quiz application built using ReactJS. <br /><br /> Currently it\'s loaded with JS questions, but you can easily replace it with differnet questions. <br /><br /> It will dynamically load the question - answer pairs and upload them into the components.' ,
